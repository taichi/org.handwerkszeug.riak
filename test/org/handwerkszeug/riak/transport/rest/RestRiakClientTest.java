...
import org.handwerkszeug.riak.transport.rest.RestRiakClient;
import org.handwerkszeug.riak.transport.rest.RestRiakOperations;
...
public class RestRiakClientTest {
	...
	public void setUp() throws Exception {
		this.target = new RestRiakClient(RestRiakConfig.newConfig(Hosts.RIAK_HOST));
	}
